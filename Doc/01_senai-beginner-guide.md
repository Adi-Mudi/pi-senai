...
| `/chirpi-configure-architect-inputs` | Select documents for the architect. |
| `/chirpi-generate-architect` | Generate a project-specific architecture agent and skills. |
