...
- `/senai-suggest-architect` — pick architecture from the library via 4 project questions; no input docs required. Falls back to a new-entry template if no match.
