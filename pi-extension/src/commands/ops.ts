...
import { buildCadenceBlock, loadCadenceState, resetCadence } from "../implement/cadence.js";

export function registerResetCommand(pi: ExtensionAPI) {
...
// full diagnostic.
export function registerLockInfoCommand(pi: ExtensionAPI) {
...
export function registerLockForceCommand(pi: ExtensionAPI) {
...
export function registerCadenceStatusCommand(pi: ExtensionAPI) {
...
export function registerCadenceResetCommand(pi: ExtensionAPI) {
