...
import { getUserAgentsDir } from "./discovery.js";
import {
  SENAI_ROLES,
  ROLE_LABELS,
  type SenaiRole,
...
export const CONFIG_COMMENT =
  "Senai config: maps each Senai role to an agent name. Managed by /chirpi-generate-architect and /senai-generate-sub-agents (manual override: /senai-configure-agents). Hand-edit only if you know the role names.";
