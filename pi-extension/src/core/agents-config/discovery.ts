// Layer 0 — agent discovery: types, path helpers, and directory scanning.
// All of discovery lives here so Layer 1 modules (brainstorm, doctor) can
// import it without reaching up into Layer 2 (agents/).
