import type { AgentFrontmatter } from "../core/agents-config/discovery.js";
...
export const ROLE_REQUIRED_TOOLS: Partial<Record<SenaiRole, string[]>> = {
	...
	"reviewer-architecture": ["read", "write"],
...
// Strict web-tool lock. The single source of truth lives in
// core/agents-config/suggestions.ts (layer 0) so both the spawn-time guard
// (hooks/spawn-guard.ts) and this doctor audit enforce the same rule.
export { WEB_TOOLS, WEB_TOOL_ALLOWED_ROLES } from "../core/agents-config/suggestions.js";
