...
import { discoverArchitectureLibrary, detectPiExtension } from "@adi-mudi/pi-chirpi";
import { loadDrivers, createEmptyDrivers } from "@adi-mudi/pi-chirpi/dist/pi-extension/src/architect/drivers.js";
		...
		try {
			...
			if (importsPi && peer === undefined) {
				items.push({
					...
					details: [
						"Extensions must list @earendil-works/pi-coding-agent, @earendil-works/pi-ai, and @sinclair/typebox in peerDependencies with '*' range.",
					],
				});
