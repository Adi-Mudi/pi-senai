...
describe("agent-generator", () => {
  ...
  it("GENERATOR_VERSION is 8 (community-researcher added)", () => {
    assert.strictEqual(
      GENERATOR_VERSION,
      8,
      `GENERATOR_VERSION must be 8. If you bumped it for another change, update this test and the v8 comment block in generator.ts.`,
    );
  });
...
describe("sub-agent regeneration", () => {
  ...
  it("GENERATOR_VERSION is 8 (community-researcher added in v8)", () => {
    assert.strictEqual(GENERATOR_VERSION, 8, "GENERATOR_VERSION must be 8 after the v8 community-researcher addition");
  });
