...
describe("constants", () => {
  ...
  it("getArtifactPaths returns all 23 fields", () => {
    const artifacts = getArtifactPaths(cwd, "run-1");
    ...
    assert.strictEqual(artifacts.reviewArchitecture, path.join(runDir, "plan/reviews/review-architecture.md"));
    assert.strictEqual(artifacts.manifestDiffReport, path.join(runDir, "implement/manifest-diff-report.md"));
    assert.strictEqual(artifacts.archRulesReport, path.join(runDir, "implement/arch-rules-report.md"));
    assert.strictEqual(artifacts.frameworkRulesReport, path.join(runDir, "implement/framework-rules-report.md"));
