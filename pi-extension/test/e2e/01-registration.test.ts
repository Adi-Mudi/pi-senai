...
const EXPECTED_COMMANDS = [
	...
	"senai-cadence-reset",
	// senai-suggest-architect, senai-generate-architect and
	// senai-configure-architect-inputs moved to @adi-mudi/pi-chirpi as
	// chirpi-predefined-architect, chirpi-generate-architect and chirpi-configure-architect-inputs.
];
