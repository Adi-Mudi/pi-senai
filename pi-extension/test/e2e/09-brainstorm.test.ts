...
describe("e2e/09-brainstorm", () => {
	...
	it("pre-run /senai-brainstorm creates a draft mission-brief.md", { timeout: 60_000 }, async (t) => {
		...
		// /senai-brainstorm is conversational; in E2E we simulate the parent
